...
insert into funnel_stages (
  ...
  ('custom', 'Custom', 'pre_interview', 90, 'gray', false, true, true, false, true),
...
insert into funnel_transitions (from_slug, to_slug) values
  ...
  ('call_logged_nurturing', 'comps'),
  ('call_logged_nurturing', 'trash_lead'),
  ('call_logged_nurturing', 'intent'),
  ('call_logged_nurturing', 'custom'),
  ...
  ('retarget_next_batch', 'intent'),
  ('retarget_next_batch', 'custom'),
  ...
  ('comps', 'new_lead'),
  ('comps', 'call_logged_nurturing'),
  ('comps', 'intent'),
  ('comps', 'custom'),
  ('comps', 'r1_booked'),
  ('comps', 'closed_deferred'),
  ('comps', 'closed_lost'),
  ('trash_lead', 'new_lead'),
  ('trash_lead', 'closed_lost'),
  ('intent', 'new_lead'),
  ('intent', 'call_logged_nurturing'),
  ('intent', 'dnp'),
  ('intent', 'custom'),
  ('intent', 'r1_booked'),
  ('intent', 'closed_deferred'),
  ('intent', 'closed_lost'),
  ('custom', 'new_lead'),
  ('custom', 'call_logged_nurturing'),
  ('custom', 'dnp'),
  ('custom', 'intent'),
  ('custom', 'r1_booked'),
  ('custom', 'closed_deferred'),
  ('custom', 'closed_lost'),
