...
export function guessHiveStage(raw: string): Stage | null {
  ...
  const heuristics: [RegExp, Stage][] = [
    ...
    [/\blost\b|\brejected\b/, "closed_deferred"],
    [/\boffer(ed)?\s*accept/, "offered_accepted"],
    [/\bstudent\s*reject/, "student_reject"],
    [/\boffer(ed)?\b/, "offered"],
    [/\byet to offer\b/, "yet_to_offer"],
    [/\br3\b.*\breject/, "r3_reject"],
    ...
    [/\bretarget/, "retarget_next_batch"],
    [/\badmission\s*team\s*reject/, "admission_team_rejected"],
