          ...
          {campaigns.map((campaign) => {
            ...
            return (
              <li key={campaign.id} className="px-5 py-4">
                ...
                {list.length === 0 ? (
                  <p className="mt-2 text-sm text-muted">No creatives yet.</p>
                ) : (
                  <ul className="mt-3 space-y-2">
                    {list.map((cr) => (
                      <li
                        key={cr.id}
                        className="flex flex-col gap-1 rounded-xl border border-border px-3 py-2 sm:flex-row sm:items-center sm:justify-between"
                      >
                        <div>
                        ...
                        <code className="text-xs text-periwinkle">
                          {appOrigin}/go/{cr.tracked_slug}
                        </code>
                      </li>
                    ))}
                  </ul>
